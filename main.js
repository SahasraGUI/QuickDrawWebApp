...
document.getElementById('sketch_to_be_drawn_result').innerHTML = 'Sketch to be drawn ' + sketch;
...
function gotResult() {
    ...
    document.getElementById("sketch_result").innerHTML = drawn_sketch;
    document.getElementById("sketch_confidence").innerHTML = Math.round(results[0].confidence*100);
}
